...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-xl mx-auto bg-[#232329] rounded-lg shadow p-6">
        <h2 class="text-xl font-bold text-[#f3f4f6] mb-6">Add User</h2>
        <form method="POST" action="{{ route('admin.users.store') }}">
            @csrf
            <div class="mb-4">
                <label class="block text-sm text-[#b3b3b3] mb-1">Name</label>
                <input type="text" name="name" value="{{ old('name') }}" class="w-full bg-[#18181b] text-[#f3f4f6] border border-[#38383f] rounded px-3 py-2" required />
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{ old('email') }}" class="w-full bg-[#18181b] text-[#f3f4f6] border border-[#38383f] rounded px-3 py-2" required />
            ...
            <div class="mb-4">
                <label class="block text-sm text-[#b3b3b3] mb-1">Password</label>
                <input type="password" name="password" class="w-full bg-[#18181b] text-[#f3f4f6] border border-[#38383f] rounded px-3 py-2" required />
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" class="w-full bg-[#18181b] text-[#f3f4f6] border border-[#38383f] rounded px-3 py-2" required />
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-[#38d4ae] text-[#18181b] px-4 py-2 rounded hover:bg-[#2bbd99] transition font-semibold">Add User</button>
            </div>
        </form>
    </div>
</div>
