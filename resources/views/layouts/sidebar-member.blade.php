    ...
    <div class="h-full px-4 py-6 overflow-y-auto bg-[#232329] dark:bg-[#232329] flex flex-col justify-between">
        <div>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('member.dashboard') }}" class="flex items-center p-2 rounded-lg transition group hover:scale-[1.03] hover:shadow-md hover:bg-[#38d4ae]/90 hover:text-[#18181b] {{ request()->routeIs('member.dashboard') ? 'bg-[#38d4ae] text-[#18181b] shadow' : 'text-[#f3f4f6]' }}">
                ...
                <li>
                    <a href="{{ route('member.tasks.index') }}" class="flex items-center p-2 rounded-lg transition group hover:scale-[1.03] hover:shadow-md hover:bg-[#38d4ae]/90 hover:text-[#18181b] {{ request()->routeIs('member.tasks.*') ? 'bg-[#38d4ae] text-[#18181b] shadow' : 'text-[#f3f4f6]' }}">
                ...
                <li>
                    <a href="{{ route('member.projects.index') }}" class="flex items-center p-2 rounded-lg transition group hover:scale-[1.03] hover:shadow-md hover:bg-[#38d4ae]/90 hover:text-[#18181b] {{ request()->routeIs('member.projects.*') ? 'bg-[#38d4ae] text-[#18181b] shadow' : 'text-[#f3f4f6]' }}">
