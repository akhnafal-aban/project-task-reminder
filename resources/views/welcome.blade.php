    ...
    @else
        <style>
            ...
            @layer utilities {
                ...
                .marker\:text-fuchsia-500::marker {
                ...
                .bg-lime-200 {
                    background-color: theme('colors.lime.200')
                }
                ...
                .bg-lime-600 {
                    background-color: theme('colors.lime.600')
                }
                ...
                .bg-lime-900 {
                    background-color: theme('colors.lime.900')
                }

                .bg-lime-950 {
                    background-color: theme('colors.lime.950')
                }
                ...
                .bg-emerald-300 {
                    background-color: theme('colors.emerald.300')
                }
                ...
                .bg-cyan-950 {
                    background-color: theme('colors.cyan.950')
                }
                ...
                .bg-violet-200 {
                    background-color: theme('colors.violet.200')
                }
                ...
                .bg-violet-900 {
                    background-color: theme('colors.violet.900')
                }

                .bg-violet-950 {
                    background-color: theme('colors.violet.950')
                }
                ...
                .bg-fuchsia-50 {
                    background-color: theme('colors.fuchsia.50')
                }
                ...
                .bg-fuchsia-800 {
                    background-color: theme('colors.fuchsia.800')
                }
                ...
                .bg-fuchsia-950 {
                    background-color: theme('colors.fuchsia.950')
                }
                ...
                .bg-pink-950 {
                    background-color: theme('colors.pink.950')
                }
                ...
                .bg-rose-950 {
                    background-color: theme('colors.rose.950')
                }
...
<body class="min-h-screen bg-gray-950 text-gray-100 flex items-center justify-center font-sans">
    <div class="w-full max-w-xl mx-auto p-8 rounded-2xl shadow-2xl bg-gray-900/80 border border-gray-800 flex flex-col items-center gap-8">
        <div class="flex flex-col items-center gap-2">
            <svg class="w-20 h-20 text-indigo-400 mb-2" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 28 32"><path stroke-linecap="round" stroke-linejoin="round" d="M14 7v7l4.5 2.5m7.5 2.5a11 11 0 11-22 0 11 11 0 0122 0z" /></svg>
            <div class="flex flex-col items-center text-center">
                <h1 class="text-4xl md:text-5xl font-bold tracking-tight mb-2">Welcome to Project Task Reminder</h1>
                <p class="text-lg text-gray-400 max-w-md">A modern Laravel project management system with dark mode, role-based dashboards, and smart reminders.</p>
            </div>
        </div>
        <div class="flex flex-col md:flex-row gap-4 w-full justify-center">
            @auth
                <a href="{{ url('/dashboard') }}" class="px-6 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold shadow transition">Go to Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="px-6 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold shadow transition">Login</a>
                <a href="{{ route('register') }}" class="px-6 py-3 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-100 font-semibold shadow transition">Register</a>
            @endauth
        </div>
        <div class="mt-6 text-xs text-gray-500 text-center">
            <p>Modern UI/UX &mdash; Laravel {{ Illuminate\Foundation\Application::VERSION }} &mdash; TailwindCSS</p>
            <p>Develop By Noor Akhnafal Aban</p>
        </div>
    </div>
</body>
</html>
